        ...
        <div class="important">
          ...
          <section class="text item tablebox">
            ...
            >
              ...
              <el-table-column align="center" prop="fkRoleNames" width="100" label="角色名称"></el-table-column>
              <el-table-column align="center" prop="username" width label="姓名"></el-table-column>
              <el-table-column align="center" prop="sex" width="100" label="性别"></el-table-column>
...
export default {
  ...
  mounted(){
    this.axios.get(useraddselect).then((response)=>{
      console.log(response)
