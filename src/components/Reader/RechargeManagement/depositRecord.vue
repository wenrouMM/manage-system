        ...
        <div class="important">
          ...
          <section class="text item tablebox">
            <el-table class="tableBorder" :data="tableData"style="width: 100%; text-align:center;" :row-style="rowStyle" :header-cell-style="{background:'#0096FF', color:'#fff',height:'60px'}">
              ...
              <el-table-column align="center" prop="depositTime" width="180" label="充值时间"></el-table-column>
              <el-table-column align="center" prop="depositMethods" width="150" label="充值方式"></el-table-column>
              <el-table-column align="center" prop="depositMoney" width="150" label="充值金额"></el-table-column>
