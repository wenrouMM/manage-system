        ...
        <div class="important">
          ...
          <section class="text item tablebox">
            <el-table class="tableBorder" :data="tableData"style="width: 100%; text-align:center;" :row-style="rowStyle" :header-cell-style="{background:'#0096FF', color:'#fff',height:'60px'}">
              ...
              <el-table-column align="center" prop="bookName" width="180" label="书籍名称"></el-table-column>
              <el-table-column align="center" prop="bookCode" width="180" label="书籍编码"></el-table-column>
              <el-table-column align="center" prop="renewTime" width="180" label="借书时间"></el-table-column>
              <el-table-column align="center" prop="bookNum" width="180" label="续借次数"></el-table-column>
              <el-table-column align="center" prop="endTime" width="180" label="预计归还时间"></el-table-column>
            </el-table>
          </section>
