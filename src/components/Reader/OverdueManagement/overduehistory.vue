      ...
      <div class="box-card">
        ...
        <div class="important">
          ...
          <section class="text item tablebox">
            <el-table  :data="tableData" style="width: 100%; text-align:center;" v-loading="tableLoading" :row-style="rowStyle" :header-cell-style="{background:'#0096FF', color:'#fff',height:'60px'}">
