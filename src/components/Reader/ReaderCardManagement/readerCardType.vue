    ...
    <el-container>
      <div class="box-card">
        ...
        <div class="important">
          ...
          <section class="searchBox" style="display: flex;flex-direction: row">
            <div class="buttonBox">
              <button class="add" @click="addDialogOpen">
                <i class="addIcon el-icon-plus"></i>添加
              </button>
            </div>
            <el-form :inline="true" :model="formInline" class="demo-form-inline" style="margin-left:800px">
          ...
          <section class="text item tablebox">
            ...
            >
              ...
              <el-table-column align="center" prop="editTime" width="270" label="修改时间"></el-table-column>
