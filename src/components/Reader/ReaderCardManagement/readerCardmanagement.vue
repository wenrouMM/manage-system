        ...
        <div class="important">
          ...
          <section class="searchBox">
            <el-form :inline="true" :model="formInline" class="demo-form-inline" style="display: flex;flex-direction: row;">
              ...
              <el-form-item label="卡号:" style='margin-left: 370px'>
                <el-input size="120" v-model="formInline.userName" placeholder="请输入卡号"></el-input>
              </el-form-item>
              <el-form-item label="用户名:" size="160">
                <el-input v-model="formInline.userId" placeholder="请输入用户名"></el-input>
              </el-form-item>
              ...
              <el-form-item label="状态:" size="160">
                <el-select v-model="formInline.userType" placeholder="请选择状态">
                  <el-option
                    v-for="(option,index) of optionsData"
                    :key="index"
                    :label="option"
          ...
          <section class="text item tablebox">
            ...
            >
              ...
              <el-table-column align="center" prop="typeName" width="150" label="类型名称"></el-table-column>
              <el-table-column align="center" prop="address" width="170" label="所属地区"></el-table-column>
              <el-table-column align="center" prop="startTime" width="170" label="创建时间"></el-table-column>
              <el-table-column align="center" prop="editTime" width="170" label="修改时间"></el-table-column>
