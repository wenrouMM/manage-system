        ...
        <div class="important">
          ...
          <section class="text item tablebox">
            ...
            >
              ...
              <el-table-column align="center" prop="gradeName" width label="等级名称"></el-table-column>
              <el-table-column align="center" prop="renewNum" width="100" label="续借次数"></el-table-column>
              <el-table-column align="center" prop="readerNum" width="200" label="借阅时间"></el-table-column>
              <el-table-column align="center" prop="bookNum" label="借书数量"></el-table-column>
