  ...
  <div id="Notice">
    <el-container>
      <div class="commonMode" style="width:100%">
        <div class="sonTitle">
          <span class="titleName">押金流向</span>
        </div>
        <!-- 2.0表单填写 -->
        ...
        <section class="tableBox">
          ...
          >
            ...
            <el-table-column align="center" prop="momentum" label="逾期金额" :show-overflow-tooltip="true"></el-table-column>
...
<script>
  ...
  import { collection,recharge } from "../../request/api/base.js";
