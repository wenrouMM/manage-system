  ...
  <div id="Notice">
    <el-container>
      <div class="commonMode" style="width:100%;overflow: auto">
        <div class="sonTitle">
          <span class="titleName">荐购历史记录</span>
        </div>
        <!-- 2.0表单填写 -->
        ...
        <section class="tableBox"  v-loading="tableLoading">
          ...
          >
            ...
            <el-table-column align="center" prop="fkReaderName" label="读者名字" :show-overflow-tooltip="true">
              <template slot-scope="scope">
            ...
            <el-table-column align="center" prop="createTime" label="创建时间" :show-overflow-tooltip="true"></el-table-column>
            <el-table-column align="center" prop="state" label="审核状态" :show-overflow-tooltip="true">
              <template slot-scope="scope">
                <span v-if="scope.row.state ==0">未审核</span>
                <span v-else-if="scope.row.state ==1">通过</span>
                <span v-else="scope.row.state ==2">驳回</span>
              </template>
            </el-table-column>
            <el-table-column align="center" prop="examine" label="审核意见" :show-overflow-tooltip="true">
              <template slot-scope="scope">
                <span>{{scope.row.examine == null || scope.row.examine=='' ?'---':scope.row.examine}}</span>
              </template>
            </el-table-column>
          </el-table>
          <!-- 4.0 分页 -->
...
<script>
  ...
  import { recommHis } from "@request/api/base.js";
