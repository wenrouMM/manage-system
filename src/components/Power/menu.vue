<template>
    <div style="display: flex;flex-direction: row;">
      ...
      <div style="width: 1320px;margin-left: 30px;;height:852px;background-color:white">
        <el-form :model="ruleForm"
          ...
          <el-form-item label="菜单类型 :" prop="menuType">
            <el-select v-model="ruleForm.menuType" clearable placeholder="请选择" @change="change_select(ruleForm.menuType)" style="width: 600px">
          ...
          <el-form-item label="菜单描述 : " prop="menuMsg">
            <el-input type="textarea" v-model="ruleForm.menuMsg"></el-input>
          </el-form-item>
          ...
          <el-form-item label=" 按 钮 集 : " prop="menuMsg" id="btn_select" style="display: none">
            <div class="myfont"  style="display: flex;flex-direction: row;position: relative">
              <img src="../../base/img/menu/tianjia.png" style="width: 25px;height: 25px;margin-top: -32px" @click="btn_type" @mouseover="myMessagebox" @mouseleave="myMessagebox1">
              <img src="../../base/img/menu/messagebox.png" style="position: absolute;top: -15px;left: -20px;width: 330px;height: 60px;display: none" id="messagebox">
              <p style="font-size: 10px;color: white;position: absolute;top: -10px;left: 5px">如果您有已存在的按钮，则不能添加与之相同的按钮</p>
            ...
            <div style="background-color: white;border-bottom-left-radius: 10px;border-bottom-right-radius: 10px">
              <el-form ref="formButton"  :model="formButton" label-width="80px" :label-position="labelPosition" style="padding-left:80px;padding-bottom: 50px ;margin-top: 50px">
                ...
                <el-form-item label="元素类型 :">
                  <el-select v-model="formButton.buttonTypeCode" clearable placeholder="请选择按钮类型" id="type" style="width: 267px" @change="change_but(formButton.buttonType)">
...
export default {
  ...
  data() {
    return {
      ...
      pId:null,
      addButton:true,
      authTbMenuElementsEdit:[],
      authTbMenuElementsAdd:[]
    };
  },
  methods: {
    change_but(num){
    ...
    click_ok() {
      console.log(this.formButton.buttonTypeCode,this.formButton.buttonName)
      if (this.formButton.buttonTypeCode ===undefined||this.formButton.buttonName===undefined) {
        ...
        this.buttonData.push(this.formButton.buttonTypeCode)
        this.findSame(this.buttonData)
        this.buttonData = serialize.deteleObject(this.buttonData)
        if(this.addButton==true){
          this.buttonNameData.push(this.formButton.buttonName)
          this.authTbMenuElementsEdit.push({
          ...
          this.authTbMenuElementsAdd.push({
            elmName: this.formButton.buttonName,
            elmCode: this.formButton.buttonTypeCode,
            fkElmCode: this.formButton.buttonTypeCode
          });
      ...
      if(treeNode.menu_code_type=='page_menu') {
        this.axios.get(menubutton, {params: {id: treeNode.id}}).then((res) => {
          ...
          if (res.data.state == true) {
            ...
            click = 'click' //是否点击的赋值
            this.src1 = 'http://192.168.2.54:8088/authmodule/menuInformation/getImg?id=' + treeNode.id //展示节点图片
            ...
            $('#btn_select').fadeIn()
            for (var item of res.data.row.authTbMenuElements) {
              console.log(item)
