    ...
    <el-container>
                  ...
                  <div class="flexLayout" id="catalogingInput3">
                    ...
                    >
                      <div class="flexLayout">
                        ...
                        <p
                          class="searchButton"
                          style="width: 50px;left: 180px"
                          @click="typeTreeFun"
                        >
                          <img
                            src="../../base/img/currency/ssbs.png"
      ...
      <div id="typeMessage">
        <div style="position: relative">
          <p>{{messageName}}</p>
          <img
            src="../../base/img/menu/xx.png"
            style="position: absolute;top: 10px;left: 340px;width: 30px;height: 30px"
            @click="closeCheck"
          >
        </div>
        <div>
...
export default {
  ...
  methods: {
    ...
    submitForm() {
      console.log(
        "defaultDateRent",
        this.addForm.defaultDateRent,
        "norForLoan",
        this.addForm.norForLoan
      );
      if (this.i == 1) {
