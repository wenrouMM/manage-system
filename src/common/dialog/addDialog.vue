<template>
  <div class="test">
    ...
    <!-- 测试框 -->
    <div @click="openAddForm">点击测试</div>
    <transition name="dialog">
      <div class="addDialog" v-if="addDialog">
        <div class="dialogTitle">
          <p>添加</p>
          <i class="close" @click="cancelAddForm()"></i>
        </div>
        <div class="dialogBody">
          ...
          >
            <!-- 上传图片 -->
            <div class="upload mb_30" @click="addpoint">
              <!-- 背景图片做改动 -->
          ...
          <div class="dialog-footer">
            <span class="dialogButton true mr_40" @click="submitAddForm">确 定</span>
            <span class="dialogButton cancel" @click="cancelAddForm">取消</span>
          </div>
        </div>
      </div>
    </transition>
